...
static uint8_t MakeReadTx(uint16_t Addr16, uint16_t AddrLen16){return 0;}
static uint8_t MakeWriteTx(uint16_t Addr16, uint16_t AddrLen16){return 0;}
static uint8_t ReadVasData(void){return 0;}
static uint8_t ChkVasData(void){return 0;}
static uint8_t ChckSeccStat(void){return 0;}
static uint8_t SendChrgReady(void){return 0;}
static uint8_t SendChrgPrm(void){return 0;}
uint8_t InitSecc(void){return 0;}
uint8_t ChrgSecc(void){return 0;}
uint8_t SeccSenario(void){return 0;}
static void* SeccRS232ReqTask(void* arg){}
