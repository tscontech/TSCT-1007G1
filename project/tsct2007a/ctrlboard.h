...
/* Legacy
#define  CST_CONNECTOR_DOOR			(1)  	// Bit[01] Connector Door Close 1 Open 0 - NOT USE
...
/* v1.4.0
#define  TSCT_CONNECTOR_DOOR		(1)    // Bit[01] Connector Door Open 0, Close 1 - NOT USE
#define  TSCT_RFID_TEST      		(4)    // Bit[04] RFID Reader Communication Err o, Ok 1
#define  TSCT_TOUCH_TEST      		(6)    // Bit[06] Touch Panel Communication Err o, Ok 1
#define  TSCT_IN_OVER_VOLTAGE		(8)	   // Bit[08] 입력 과전압 Err 0, Ok 1
#define  TSCT_IN_OVER_CURRENT		(9)    // Bit[09] 입력 과전류 Err 0, Ok 1
#define  TSCT_OUT_OVER_VOLTAGE		(10)    // Bit[10] 출력 과전압 Err 0, Ok 1
#define  TSCT_OUT_OVER_CURRENT		(11)	// Bit[11] 출력 과전류 Err 0, Ok 1
#define  TSCT_GROUND_FAULT			(13)    // BIT[13] 지락 Err 0, Ok 1
#define  TSCT_IN_UNDER_CURRENT		(26)	// Bit[26] 입력 저전압 Err 0, Ok 1
#define  TSCT_EMG_SW				(14)	// Bit[14] 비상 스위치 On 0, Ok 1
#define  TSCT_CONNECT_TIMEOUT       (17)    // Bit[17] Connection Time Out 0, Ok 1
#define  TSCT_OVER_TEMP             (22)    // Bit[22] Over Temperature Err 0, Ok 1
#define  TSCT_OVER_POWER            (23)    // Bit[23] Over Power Err 0, Ok 1
#define  TSCT_COM_WHM				(29)	// Bit[29] communication with power meter Err 0, Ok 1	
*/
...
#define  TSCT_CONNECT_TIMEOUT       (17)    // Bit[17] Connection Time Out 0, Ok 1
#define  TSCT_OVER_TEMP             (22)    // Bit[22] Over Temperature Err 0, Ok 1
#define  TSCT_OVER_POWER            (23)    // Bit[23] Failed to control power(Over power detected) Err 0, Ok 1
#define  TSCT_IN_UNDER_VOLTAGE		(26)	// Bit[26] 입력 저전압 Err 0, Ok 1
#define  TSCT_COM_WHM				(29)	// Bit[29] communication with power meter Err 0, Ok 1
#define  TSCT_MEMORY				(30)	// Bit[30] memory space 	 Bad 0, Ok 1
...
/* v1.4.0
#define ERR_SERVER_DISCON           (0)     // Server Disconnect 
#define ERR_RESET                   (1)     // System Reset
#define ERR_AMI_DISCON              (2)     // AMI Disconnect
#define ERR_OV_VOLT                 (23)    // Over Voltage
#define ERR_OV_CURT                 (24)    // OVer Current
#define ERR_UD_VOLT                 (25)    // Under Voltage
