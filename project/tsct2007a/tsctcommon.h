...
#define DEVICE_1007G1 1

#if DEVICE_2007C

#elif DEVICE_1007G1

#define GPIO_PLC_PWR_RELAY_CTL	22  //19->22, EPT, RFID, IDA도 같이 켬

//Touch Key
#define GPIO_TOUCHKEY1		15  //1007G1 터치키

//LED
#define GPIO_LED_RED			46
#define GPIO_LED_GREEN			44
...
#define GPIO_CP_RL3 19
#define GPIO_CP_RL4 45

//BL0939
#define BL0939_DEV ITP_DEVICE_UART4
#define GPIO_BL0939_LEAK 18

#endif


// Common
//#define GPIO_BUZZER			45  //Buzzer는 Touch Sensor에 연동되도록 변경
// #define GPIO_PILOT_PWR1		22
// #define GPIO_PILOT_PWR2		19

#define GPIO_BACKLIGHT		38  //그대로
...
// #define GPIO_RS485_EN2		49  -> RS485가 아닌 Touch Enable로, G1에서 삭제됨
...
// #define GPIO_AUDIO_EN		25 //Audio Amp Enable로, Rev3에서 삭제됨
...
bool powerControlPLC(bool power);
